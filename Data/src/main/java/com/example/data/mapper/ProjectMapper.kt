...
open class ProjectMapper : EntityMapper<ProjectEntity,Project> {
    ...
    override fun mapToEntity(domain: Project): ProjectEntity {
        return ProjectEntity(domain.id,domain.name,domain.fullname,domain.starCount,domain.dateCreated,domain.ownerName,domain.ownerAvater,domain.isBookmarked)
    }
